...
export class SubmitActionDto {
  ...
  @IsString({ message: "Recycling point ID must be a valid string" })
  ...
  @IsEnum(MaterialType, {
    message: "Invalid material type. Please scan a supported material.",
  })
  ...
  @IsString({ message: "Image hash must be provided" })
  imageHash: string;
  ...
  @IsString({ message: "Perceptual hash must be provided" })
