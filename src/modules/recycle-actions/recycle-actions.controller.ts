...
export class RecycleActionsController {
  ...
  @ApiOperation({
    ...
    description:
      "Submit a recycling action with image and metadata. The action will be verified asynchronously.",
  })
  ...
  @ApiStandardResponse(SubmitActionResponseDto, {
    status: 202,
    description:
      "Recycling action submitted successfully. Processing asynchronously.",
    example: {
      verified: false,
  ...
  @ApiOperation({
    ...
    description:
      "Get paginated list of recycling actions for the authenticated user",
  })
  @ApiQuery({
    name: "page",
    required: false,
