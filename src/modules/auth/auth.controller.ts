...
import { AuthResponseDto, RegisterResponseDto } from '../../common/dto/auth-response.dto';
...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Login successful, returns access and refresh tokens', type: AuthResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'New access token generated', type: AuthResponseDto })
