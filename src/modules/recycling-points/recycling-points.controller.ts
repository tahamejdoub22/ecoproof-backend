...
export class RecyclingPointsController {
  ...
  @Get()
  @ApiOperation({
    summary: "Get all recycling points",
    description: "Retrieve all active recycling points",
  })
  @ApiResponse({
    status: 200,
    description: "List of recycling points",
    type: [RecyclingPointDto],
  })
  async findAll() {
  ...
  @Get("nearest")
  @ApiOperation({
    summary: "Find nearest recycling points",
    description: "Find recycling points near a location",
  })
  @ApiQuery({
    name: "lat",
  ...
  @ApiResponse({
    status: 200,
    description: "List of nearest recycling points",
    type: [RecyclingPointDto],
  })
  ...
  @Get(":id")
  @ApiOperation({
    summary: "Get recycling point by ID",
    description: "Retrieve a specific recycling point by its ID",
  })
  @ApiParam({
    name: "id",
  ...
  @ApiResponse({
    status: 200,
    description: "Recycling point details",
    type: RecyclingPointDto,
  })
